...
public class DataTypes {
	...
	public static void main(String[] args) {
		 ...
		 * Java follows Strict data type pattern
		 * 
		 *1. Primitive Data Type: --Primitive data types can be directly used inside the memory there is no need to create any Object
		 *Two Types of Primitive data Type  
		 * a. Boolean type : Boolean(True/False)'
		 * b. Numeric Type
		 * b.1. : Character Type :char
		 * b.2: Integral Type:
		 * b.2.1: Integer: byte,short,int,long
		 * b.2.2: floating: double,float
		 * 
		 *  
		 * 
